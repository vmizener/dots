...
" Changelog {{{
"     Thu Jul 25 2019 {{{
"       - Commented out gutentags temporarily
"     }}}
"     Tue Jul 23 2019 {{{
"       - Reorganized this file; added fold markers
"       - Buffers are now hidden when out of view (no need to save upon
"         switching buffer views now)
"       - Removed bling/vim-bufferline plugin; no more bufferline at top
...
call plug#begin('~/.config/nvim/plugged')
    ...
    " LanguageClient is a language server protocol" (LSP) for neovim
...
" Formatting {{{
    ...
    set breakindent     " Indent line-breaks when line wrapping
    set expandtab       " substituted tabs with spaces
